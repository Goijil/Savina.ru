      ...
      <div id="2" className="px-10">
        ...
        <div className="flex justify-center">
          <img
            src="public\test.jpg"
            alt="#"
            className="2xl:w-[500px] 2xl:h-[625px] xl:w-[450px] xl:h-[562px] lg:w-[400px] lg:h-[500px] md:w-[350px] md:h-[438px] sm:w-[300px] sm:h-[376px] w-[250px] h-[314px] "
            style={{
